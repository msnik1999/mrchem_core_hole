...
bool setup(OrbitalVector &Phi, double prec, const Nuclei &nucs, int zeta, int n_components = 1);
void project_ao(OrbitalVector &Phi, double prec, const Nuclei &nucs, int zeta, int n_components = 1);
